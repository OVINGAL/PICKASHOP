...
package com.oddsoft.pickashop.Widgets;
 ...
 * via {@link #setSelectedIndicatorColors(int...)} and {@link }. The
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private int mHeaderColor = R.color.white;
...
// Make sure that the Tab Strips fills this View
    ...
    public void headerColor(int color) {
        mHeaderColor = color;
    }
